                    ...
                    <div class="mb-6">
                        <form action="" method="POST" id="userForm">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    <label for="subs_id" class="block text-gray-700 dark:text-gray-800 mb-1">Subscription
                                        ID
                                    </label>
                                    <input placeholder="input Subs ID" value="{{ $subs->subs_id }}" type="text"
                                        id="subs_id" name="subs_id"
                                        class="w-full rounded-lg border py-2 px-3 dark:bg-gray-200 dark:text-gray-900 dark:border-gray-300">
                                </div>
                                <div>
                                    <label for="subs_name" class="block text-gray-700 dark:text-gray-800 mb-1">Subscription
                                        Name</label>
                                    <input type="text" value="{{ $subs->subs_name }}" placeholder="input name"
                                        id="subs_name" name="subs_name"
                                        class="w-full rounded-lg border py-2 px-3 dark:bg-gray-200 dark:text-gray-900 dark:border-gray-300">
                                </div>
                            ...
                            <div class="grid grid-cols-2 gap-4 mt-4">
                                ...
                                <div>
                                    ...
                                    <select name="odp_id" id="odp_id"
                                        ...
                                        @foreach ($odps as $odp)
                                            <option {{ $odp->odp_id == $subs->odp_id ? 'selected' : '' }}
                                                value="{{ $odp->odp_id }}">
                                                {{ $odp->odp_name }}</option>
                                        @endforeach
                                    </select>
