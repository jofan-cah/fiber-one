                        ...
                        <form action="" method="POST" id="userForm">
                            ...
                            <div class="grid grid-cols-2 gap-4 mt-4">
                                <div>
                                    <label for="odp_port_capacity"
                                        class="block text-gray-700 dark:text-gray-800 mb-1">Splitter Odp</label>
                            ...
                            <div class="grid grid-cols-2 gap-4 mt-4">
                                <div>
                                    ...
                                    <input type="text" name="odp_description" placeholder="Description For odp"
                                        id="odp_description"
                                        class="w-full rounded-lg border py-2 px-3 dark:bg-gray-200 dark:text-gray-900 dark:border-gray-300">
                                </div>
                            ...
                            <div class="grid grid-cols-2 gap-4 mt-4">
                                <div>
                                    <label for="parent_odp_id" class="block text-gray-700 dark:text-gray-800 mb-1">ODP Name
                                        Parent</label>
                                    <select name="parent_odp_id" id="parent_odp_id"
                                        ...
                                        @foreach ($odps as $p)
                                            <option value="{{ $p->odp_id }}">{{ $p->odp_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div id="splitter-container" class="hidden">
                                    <label for="splitter_id" class="block text-gray-700 dark:text-gray-800 mb-1"> Splitter
                                        ODC</label>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        Swal.fire({
                            ...
                            '/odp'; // Ubah dengan route yang sesuai
                        });
                    },
                    error: function(xhr, status, error) {
