        ...
        <div
            ...
            <div class="container mx-auto px-4 py-8">
                <div class="flex justify-between">
                    <h2 class="text-2xl font-bold mb-6">Add Paket</h2>
                    <div>
                    ...
                    <div class="mb-6">
                        <form action="" method="POST" id="userForm">
                            ...
                            <div class="grid grid-cols-1 gap-4">
                                <div>
                                    <label for="nama_paket" class="block text-gray-700 dark:text-gray-800 mb-1"> Nama Paket
                                    </label>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#userForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: '{{ route('storePaket') }}', // Ubah dengan route yang sesuai
                    method: 'POST',
                    data: formData,
                    success: function(response) {
                        ...
                        Swal.fire({
                            ...
                            window.location.href =
                                '/paket'; // Ubah dengan route yang sesuai
                        });
                    },
