                    ...
                    <div class="mb-6">
                        <form action="" method="PUT" id="userForm">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label for="odc_name" class="block text-gray-700 dark:text-gray-800 mb-1">ODC
                                        Name</label>
                                    <input type="text" value="{{ $odc->odc_name }}" placeholder="input name"
                                        id="odc_name" name="odc_name"
                            ...
                            <div class="grid grid-cols-2 gap-4 mt-4">
                                <div>
                                    <label for="odc_port_capacity"
                                        class="block text-gray-700 dark:text-gray-800 mb-1">Splitter ODC</label>
                                    <select name="odc_port_capacity" id="odc_port_capacity"
                                        class="w-full rounded-lg border py-2 px-3 dark:bg-gray-200 dark:text-gray-900 dark:border-gray-300">
                                        <option value="" selected disabled>Splitter </option>
                                        <option value="2"{{ $odc->odc_port_capacity == 2 ? 'selected' : '' }}>1 : 2
                                        </option>
                                        <option value="4" {{ $odc->odc_port_capacity == 4 ? 'selected' : '' }}>1 : 4
                                        </option>
                                        <option value="8" {{ $odc->odc_port_capacity == 8 ? 'selected' : '' }}>1 : 8
                                        </option>
                                        <option value="16" {{ $odc->odc_port_capacity == 16 ? 'selected' : '' }}>1 : 16
                                        </option>
                                    </select>
                                </div>
                                <div>
                                    ...
                                    <input type="text" value="{{ $odc->odc_addres }}" name="odc_addres"
                                        placeholder="input address" id="odc_addres"
                                        class="w-full rounded-lg border py-2 px-3 dark:bg-gray-200 dark:text-gray-900 dark:border-gray-300">
                                </div>
                            </div>
                            <div class="grid grid-cols-2 gap-4 mt-4">
                                ...
                                <div>
                                    <label for="olt_id" class="block text-gray-700 dark:text-gray-800 mb-1">OLT
                                        Name</label>
                                    <select name="olt_id" id="olt_id"
                                        class="w-full rounded-lg border py-2 px-3 dark:bg-gray-200 dark:text-gray-900 dark:border-gray-300">
                                        <option value="" selected>Select OLT</option>
                                        @foreach ($olts as $olt)
                                            <option value="{{ $olt->olt_id }}"
                                                {{ $odc->olt_id == $olt->olt_id ? 'selected' : '' }}>
                                                {{ $olt->olt_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="grid grid-cols-2 gap-4 mt-4">
                                <div>
                                    ...
                                    <select name="parent_odc_id" id="parent_odc_id"
                                        ...
                                        @foreach ($odcs as $p)
                                            <option value="{{ $p->odc_id }}"
                                                {{ $odc->parent_odc_id == $p->odc_id ? 'selected' : '' }}>
                                                {{ $p->odc_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                    ...
                                    <select name="port_number" id="port_number"
                                        ...
                                        @foreach ($ports as $port)
                                            <option value="{{ $port->id }}"
                                                {{ $port->odc_id == $odc->odc_id ? 'selected' : '' }}>
