                    ...
                    <div class="mb-6">
                        <form action="" method="PUT" id="userForm">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label for="olt_name" class="block text-gray-700 dark:text-gray-800 mb-1">OLT
                                        Name</label>
                                    <input type="text" value="{{ $olt->olt_name }}" placeholder="input name"
                                        id="olt_name" name="olt_name"
                                        class="w-full rounded-lg border py-2 px-3 dark:bg-gray-200 dark:text-gray-900 dark:border-gray-300">
                                </div>
                                <div>
                                    <label for="olt_location_maps" class="block text-gray-700 dark:text-gray-800 mb-1">Maps
                                        OLT</label>
                            ...
                            <div class="grid grid-cols-2 gap-4 mt-4">
                                <div>
                                    <label for="olt_port_capacity"
                                        class="block text-gray-700 dark:text-gray-800 mb-1">Port</label>
                                    <input type="number" min="0" value="{{ $olt->olt_port_capacity }}"
                                        name="olt_port_capacity" id="olt_port_capacity" placeholder="input port"
                                        class="w-full rounded-lg border py-2 px-3 dark:bg-gray-200 dark:text-gray-900 dark:border-gray-300">
                                </div>
                                <div>
                                    <label for="olt_addres"
                                        class="block text-gray-700 dark:text-gray-800 mb-1">Address</label>
                                    <input type="text" value="{{ $olt->olt_addres }}" name="olt_addres"
                                        placeholder="input address" id="olt_addres"
                                        class="w-full rounded-lg border py-2 px-3 dark:bg-gray-200 dark:text-gray-900 dark:border-gray-300">
                                </div>
                            </div>
                            <div class="grid grid-cols-2 gap-4 mt-4">
                                <div>
                                    <label for="olt_description"
                                ...
                                <div>
                                    <label for="type_olt" class="block text-gray-700 dark:text-gray-800 mb-1">Type
                                        OLT</label>
                                    <select name="type_olt" id="type_olt"
                                        class="w-full rounded-lg border py-2 px-3 dark:bg-gray-200 dark:text-gray-900 dark:border-gray-300">
                                        <option value="GPON" {{ $olt->type_olt == 'GPON' ? 'selected' : '' }}>GPON</option>
                                        <option value="EPON" {{ $olt->type_olt == 'EPON' ? 'selected' : '' }}>EPON</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div id="portFields">
                                ...
                                @foreach ($olt->ports as $index => $port)
                                    <div class="mb-4">
                                        <label for="port_{{ $index + 1 }}"
                                            class="block text-gray-700 dark:text-gray-800 mb-1">Port {{ $index + 1 }} -
                                            Status</label>
                                        <select name="port_{{ $index + 1 }}" id="port_{{ $index + 1 }}"
                                            class="w-full rounded-lg border py-2 px-3 dark:bg-gray-200 dark:text-gray-900 dark:border-gray-300">
                                            <option value="enabled" {{ $port->status == 'enabled' ? 'selected' : '' }}>
                                                Enabled</option>
                                            <option value="disabled" {{ $port->status == 'disabled' ? 'selected' : '' }}>
                                                Disabled</option>
                                        </select>
                                    </div>
                                    <div class="mb-4">
                                        <label for="directions_{{ $index + 1 }}"
                                            class="block text-gray-700 dark:text-gray-800 mb-1">Port {{ $index + 1 }} -
                                            Direction</label>
                                        <input type="text" name="directions[]" value="{{ $port->directions }}"
                                            placeholder="Description For OLT" id="directions_{{ $index + 1 }}"
                                            class="w-full rounded-lg border py-2 px-3 dark:bg-gray-200 dark:text-gray-900 dark:border-gray-300">
                                    </div>
                                @endforeach
                            </div>
