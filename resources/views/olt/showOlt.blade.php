                        ...
                        <div class="p-6 lg:p-8 bg-white rounded-lg shadow-lg">
                            ...
                            <div class="mt-4">
                                ...
                                <p class="mt-2 text-sm text-gray-600"><strong>Deskripsi:</strong>
                                    {{ $olt->olt_description }}</p>
                                <p class="mt-2 text-sm text-gray-600"><strong>Alamat:</strong> {{ $olt->olt_addres }}</p>
                                <p class="mt-2 text-sm text-gray-600"><strong>Lokasi:</strong> {{ $olt->olt_location_maps }}
                                </p>
                                ...
                                <tbody>
                                    @foreach ($odcs as $odc)
                                        <tr>
                                            ...
                                            <td class="border border-gray-300 px-4 py-2">{{ $odc->odc_name }}</td>
                                            <td class="border border-gray-300 px-4 py-2">{{ $odc->odc_port_capacity }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
