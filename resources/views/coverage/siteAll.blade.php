  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    olts.forEach(olt => {
      if (olt.olt_location_maps) {
        ...
        const oltIconUrl = `https://uhuy.fiberone.net.id/OLT5.png`; // Ganti dengan URL gambar yang sesuai
    ...
    odcs.forEach(odc => {
      if (odc.odc_location_maps) {
        ...
        // Ganti URL gambar dengan URL gambar di folder public
        const odcIconUrl = `https://uhuy.fiberone.net.id/ODCVIOLET.png`; // Ganti dengan URL gambar yang sesuai
    ...
    odps.forEach(odp => {
      if (odp.odp_location_maps) {
        ...
        // Ganti URL gambar dengan URL gambar di folder public
        const odpIconUrl = `https://uhuy.fiberone.net.id/ODPTOSCA.png`; // Ganti dengan URL gambar yang sesuai
