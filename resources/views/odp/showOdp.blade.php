                            ...
                            <div class="p-6 lg:p-8 bg-white rounded-lg">
                                ...
                                <div class="mt-4">
                                    <p class="mt-2 text-sm text-gray-600"><strong>Deskripsi:</strong>
                                        {{ $odp->odp_description }}</p>
                                    <p class="mt-2 text-sm text-gray-600"><strong>Alamat:</strong> {{ $odp->odp_addres }}
                                    </p>
                                    <p class="mt-2 text-sm text-gray-600"><strong>Lokasi:</strong>
                                        {{ $odp->odp_location_maps }}</p>
                                    <p class="mt-2 text-sm text-gray-600"><strong>Kapasitas Port:</strong>
                                        {{ $availablePorts ?? 0 }} / {{ $odp->odp_port_capacity }}</p>
                                </div>
                                    ...
                                    @foreach ($odc as $index => $subscription)
                                        <tr class="{{ $loop->even ? 'bg-gray-50' : 'bg-white' }}">
                                            <td class="border border-gray-300 px-4 py-2 text-sm text-gray-700">
                                                {{ $index + 1 }}</td>
                                            <td class="border border-gray-300 px-4 py-2 text-sm text-gray-700">
                                                {{ $subscription->subs_id }}</td>
                                            <td class="border border-gray-300 px-4 py-2 text-sm text-gray-700">
                                                {{ $subscription->subs_name }}</td>

                                            <td class="border border-gray-300 px-4 py-2 text-sm text-gray-700">
                                                {{ $subscription->odp->odp_name }}</td>
                                            <td class="border border-gray-300 px-4 py-2 text-sm text-gray-700">
                                                {{ $subscription->port }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
